...
type TransactionAPIList struct {
	...
	ReceiptStatus  uint32  `protobuf:"varint,8,opt,name=receipt_status,json=receiptStatus,proto3" json:"receipt_status"`
...
func (x *TransactionAPIList) GetBlockTimestamp() uint64 {
	if x != nil {
...
func (x *TransactionAPIList) GetTransactionFee() string {
	if x != nil {
...
func (x *TransactionAPIList) GetReceiptStatus() uint32 {
	if x != nil {
...
func (x *TransactionAPIList) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *TransactionAPIList) GetMethod() string {
	if x != nil {
		return x.Method
	}
	return ""
...
func (x *TransactionAPIList) GetValueDecimal() float64 {
	if x != nil {
...
func (x *TransactionAPIList) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
var file_transaction_api_list_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x6c, 0x73, 0x22, 0x81, 0x03, 0x0a, 0x12, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	...
	0x6c, 0x75, 0x65, 0x12, 0x27, 0x0a, 0x0f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x74, 0x69, 0x6d,
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0e, 0x62, 0x6c,
	...
	0x62, 0x65, 0x72, 0x12, 0x27, 0x0a, 0x0f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x5f, 0x66, 0x65, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x74, 0x72,
	0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x46, 0x65, 0x65, 0x12, 0x25, 0x0a, 0x0e,
	...
	0x18, 0x0b, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0c, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x44, 0x65, 0x63,
	0x69, 0x6d, 0x61, 0x6c, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x0c, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x6d, 0x6f,
