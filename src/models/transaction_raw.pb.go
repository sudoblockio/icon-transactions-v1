...
func (x *TransactionRaw) GetData() *any.Any {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_transaction_raw_proto_rawDesc = []byte{
	...
	0xf7, 0x06, 0x0a, 0x0e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52,
...
var file_transaction_raw_proto_depIdxs = []int32{
	...
	2, // 1: models.TransactionRaw.data:type_name -> google.protobuf.Any
