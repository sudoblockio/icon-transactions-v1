...
type TransactionCreateScoreORM struct {
	AcceptTransactionHash   string `gorm:"index:transaction_create_score_idx_accept_transaction_hash"`
	CreationTransactionHash string `gorm:"primary_key"`
	RejectTransactionHash   string `gorm:"index:transaction_create_score_idx_reject_transaction_hash"`
}
